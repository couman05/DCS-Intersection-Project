...
public class Exp3_Part1 {
	...
	public static PetriNet PN3B() {
		// ----------------------- SubPetri ------------------------------------
		PetriNet mpn = new PetriNet();
		mpn.PetriNetName = "PN3B";
		mpn.NetworkPort = 0;
		...
		Condition T33Ct2 = new Condition(t33,"p33",TransitionCondition.LessThan,"constantVal2");
	...
	public static void main(String[] args) {
		...
		SP2.SetName("PN3B");
		SubPetri pn3B = new SubPetri(PN3B());
		SP2.SetValue(pn3B);
		...
		DataFloat constantVal1 = new DataFloat();
		constantVal1.SetName("constantVal1");
		constantVal1.SetValue(2.0f);
		pn.ConstantPlaceList.add(constantVal1);
		...
		Condition T1Ct2 = new Condition(t1, "p2", TransitionCondition.LessThan,"constantVal1");
		...
		Condition T1Ct4 = new Condition(t1, "p2", TransitionCondition.MoreThanOrEqual,"constantVal1");
		T1Ct3.SetNextCondition(LogicConnector.AND, T1Ct4);

		GuardMapping grdT12 = new GuardMapping();
		grdT12.condition = T1Ct3;

		grdT12.Activations.add(new Activation(t1, "PN3B", TransitionOperation.Copy, "p3"));
